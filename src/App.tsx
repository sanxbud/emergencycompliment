    ...
    <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-amber-100 dark:bg-amber-100">
        <header className="flex flex-col items-center pb-20">
          ...
          <h1 className={'font-["Caveat"] text-5xl text-indigo-950 dark:text-indigo-950'}>Emergency Compliment!</h1>
        </header>
        ...
        <button className="bg-indigo-200 dark:bg-indigo-200 p-6 m-4 shadow-md rounded-xl hover:bg-indigo-300 dark:hover:bg-indigo-300 hover:scale-110 transform transition duration-200 ease-in-out cursor-pointer" onClick={generateCompliment}><p className="text-xl font-bold">{buttonText}</p></button>
        <div className=""><button className="cursor-pointer m-2 rounded-xl hover:scale-110 transform transition duration-200 ease-in-out" onClick={submitCompliment}><p className="font-bold text-sm text-indigo-950 dark:text-indigo-950 dark:hover:text-indigo-850">Suggest a compliment!</p></button></div>

      </div>    
     
     <footer>
       <a href="https://sanjaybudhia.dev" 
          className="block text-center text-amber-100 bg-indigo-950 font-bold text-sm py-4 dark:bg-indigo-950 dark:text-amber-100 dark:hover:bg-indigo-900 hover:bg-indigo-900 transition">
