...
//  const rand = getRand()  
  ...
  return (
    <>
     ...
     <footer className="block text-center text-amber-100 bg-indigo-950 md:font-bold text-sx md:text-sm py-4 dark:bg-indigo-950 dark:text-amber-100 dark:hover:bg-indigo-900 hover:bg-indigo-900 transition">
